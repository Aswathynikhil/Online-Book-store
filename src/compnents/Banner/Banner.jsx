          ...
          <div className='container'>
              <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6 ">
                  ...
                  <div>
                          <img
                              data-aos="zoom-in"
                              src={LibraryImg} alt="" className='max-w-[400px] block mx-auto h-[350px] w-full drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover' />
                  </div>
                  {/* text content section */}
                      <div
                          data-aos="zoom-in"
                          className='flex flex-col justify-center gap-6 sm:pt-0'>
                      <h1 className='text-3xl sm:text-4xl font-bold'>Library atbYour Fingertips</h1>
                          <p className='text-sm text-gray-500 tracking-wide leading-5 '>  hdfkjfh dhfjksdf jfksjf jkdfhjsdh,sdfhjksd dufis</p>
